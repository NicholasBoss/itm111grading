...
correct_answer_list = [[['irises.jpg'], # 1
                       ...
                       [['Youpyo', 'Aamodt'], # 6
                        ...
                        ['Marla', 'Aamodt'], 
                        ['Arumugam', 'Aamodt']],
                       [[['Berni', 'Genin', 'Development', 60598, '2001-12-27']], # 7 
                         [['Berni', 'Genin', 'Development', '60,598', '2001-12-27']],
                         [['Berni', 'Genin', 'Development', '$60,598', '2001-12-27']]]
                    ]
...
if os_name == 'Windows':
    ...
    answer = open(f"{directory}/original/week09answers.txt", "w")
        ...
        for command in sqlCommands:
            ...
            if a_number == 2: # Query 1
                if command.lower().__contains__('select'):
                    if not command.lower().__contains__('artfile'):
                        query1_clause_list.append(f"Artfile Column NOT used")
            ...
            if a_number == 9: # Query 6
                if command.lower().__contains__('select'):
                    ...
                    if not command.lower().__contains__('limit'):
                        query6_clause_list.append(f"LIMIT Clause NOT used")
