...
correct_answer_list = [[[1]],
                       [[['Venture', 'Lonzo', 'Coy', 1965, None, 'United States', 'y'], 
                        ...
                        [['Venture', 'Lonzo', 'Coy', 'United States', 'y', 1965, None], ['Leonardo', None, 'da Vinci', 'Italy', 'n', 1452, 1519], ['Deborah', None, 'Gill', 'United States', 'y', 1970, None], ['Claude', None, 'Monet', 'France', 'n', 1840, 1926], ['Pablo', None, 'Picasso', 'Spain', 'n', 1904, 1973], ['Milo', None, 'Rambaldi', 'Italy', 'n', 1444, 1495], ['Michelangelo', 'di Lodovico', 'Simoni', 'Italy', 'n', 1475, 1564], ['Vincent', None, 'van Gogh', 'France', 'n', 1853, 1890], ['Rembrandt', 'Harmenszoon', 'van Rijn', 'Netherlands', 'n', 1606, 1669]]],
                       [[3]],
                       [[4]],
