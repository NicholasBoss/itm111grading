...
Python version 3.11.7 or higher (Make sure you add it to the path/environment variables when installing)
...
On line 20 in `root.py`, you may need to replace the password with your root password if you are on a local machine. If you are using AWS to grade, you can ignore this.
